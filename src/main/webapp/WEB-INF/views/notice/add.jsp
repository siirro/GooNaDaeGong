                            ...
                            <div class="css-12l4j2c e1vbjq4w1">
                                ...
                                <div class="css-0 e1tjt2bn7">
                                    <div class="css-1gua357 e1tjt2bn5">
                                        <textarea onkeypress="onTestChange();" id="nt_contents" inputmode="text" placeholder="내용을 입력해주세요" aria-label="textarea-message" 
                            ...
                            <div class="css-mlazth edd8l6o3">
                                <div class="css-g8ewo8 e9bfpi41" id="fileBox">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="nt_yn" id="nt_yn" value="Y">
                                        <label class="form-check-label" for="inlineRadio1">공지 표시</label>
                                     </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="nt_yn" id="nt_yn" value="N">
