    ...
    <body>
            ...
            <header>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center text-lg-end" id="nav-padding">
                                <div class="d-inline-flex align-items-center">
                                    <a class="text-body px-2" href="#">회원가입</a>
                                    <a class="text-body px-2" href="#">로그인</a>
                                    <a class="text-body px-2" href="#">고객센터</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid sticky-top bg-white shadow-sm">
                    <div class="container">
                        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0" id="nav-padding">
                            <a href="../" class="navbar-brand">
                                <h1 class="m-0 text-uppercase"><img src="/resources/images/index/logo.jpg" alt="logo"></h1>
                            </a>
