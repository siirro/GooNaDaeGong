    ...
    <section>
        <div class="css-luwwab eug5r8l4">
            <div class="css-833hqy ecbxmj4">
                ...
                <ul class="css-1x9bshx ecbxmj2">
                    ...
                    <li class="css-0 ecbxmj1"><a class=" css-nk8664 ecbxmj0" hef="./myReview">상품 후기<span class="css-e41glx e1x0rfoo0"></span></a>
                    </li>

                    <li class="css-0 ecbxmj1"><a class=" css-nk8664 ecbxmj0">상품 문의<span class="css-e41glx e1x0rfoo0"></span></a>
                    </li>
        ...
        <div class="css-j0lifa ed9qr673">
            <div class="css-fhxb3m ed9qr672">
                        <h2 class="css-xr9nhh ed9qr671">문의 내역</h2>
