		            ...
		            <div class="css-i3aepa e1c07x4811">
		                <div class="css-1u8qly9 e1c07x489">
		                    <div class="e1c07x4810 css-1qpsnts e3um3060">
		                        <img src="../resources/upload/gnItem/${like.gnItemFileDTOs[0].fileName}" alt="상품 이미지" loading="lazy">
                                <span>
                                    <c:choose>
                                        <c:when test="${like eq null }">
                                            <svg class="likeButton" style="color: black;"
                                        ...
                                        <c:otherwise>
                                            <svg class="likeButton" style="color: red;" data-item-num="${like.item_num}"
                                                xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                fill="currentColor" class="bi bi-heart-fill"
                                                viewBox="0 0 16 16">
                                        <path fill-rule="evenodd"
		                ...
		                <div class="css-c1cgl e1c07x486">
		                    <div class="css-1qsrhd e1c07x485">상품이름 ${like.gnItemDTO.item_name}</div>
		                    <div class="e1c07x484 css-1drr403 ei5rudb2">
		                        <span class="sales-price css-1qe668a ei5rudb1">상품가격 ${like.gnItemDTO.item_price}원</span>
		                    </div>
		                </div>
		            </div>
                    </c:forEach>
