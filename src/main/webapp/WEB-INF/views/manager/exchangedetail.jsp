                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header py-3" style="display: flex">
                            <h6 class="font-weight" style="color: #6667AB; margin: auto 0px;">교환신청 상세</h6>
                                ...
                                <section class="col-lg-12 text-center" style="padding: 0px;">
                                    <table class="table table-hover" width="100%">
                                        <thead class="table-primary" style="font-size: 14px;">
                                            <tr>
                                                <th class="col-2">교환신청일자</th>
                                                <th class="col-1">교환번호</th>
                                                <th class="col-2">교환희망상품</th>
                                                <th class="col-7">교환사유</th>
                                            </tr>
                                        </thead>
                                        <tbody style="font-size: 12px;">
                                            <tr>
                                                <td><fmt:formatDate value="${detail.exc_date}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td>${detail.exc_num}</td>
                                                <td>${detail.exc_option}</td>
                                                <td>${detail.exc_memo}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </section>
