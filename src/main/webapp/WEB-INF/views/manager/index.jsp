...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/manager/index.css">
</head>
<body>
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="./manager">
                    ...
                    <div class="sidebar-brand-text mx-3">관리자 센터<sup></sup></div>
                </a>
...
<!-- <script src="/resources/js/manager/index.js"></script> -->
</body>
</html>