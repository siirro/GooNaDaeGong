                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" style="zoom: 0.8;">
                            ...
                            <!-- 내용 Search -->
                            <form action="./exchange" method="get" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="search-category" id="search-category">
                                            ...
                                            <select name="kind" class="custom-select custom-select-sm form-control form-control-sm">
                                                ...
                                                <option class="kinds" value="exc_num">교환번호</option>
                                ...
                                <section class="col-lg-12 text-center" style="padding: 0px;">
                                    <table class="table table-hover" width="100%">
                                      <thead class="table-primary" style="font-size: 14px;">
                                        <tr>
                                            <th class="col-2">교환신청일</th>
                                            <th class="col-2">교환번호</th>
                                      ...
                                      <tbody style="font-size: 12px;">
                                          <c:forEach items="${list}" var="nl">
                                             <tr class="reporttr" onclick="location.href='exchangeDetail?merchant_uid=${nl.merchant_uid}'">
                                                <td><fmt:formatDate value="${nl.exchangeDTO.exc_date}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            ...
                            <div class="pagediv" style="display: flex; justify-content: center;">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination paginate_sm">
                                        ...
                                        <c:if test="${pager.pre}">
                                            <li class="page-item"><a class="page-link" href="./exchange?page=${pager.startNum-1}&kind=${pager.kind}&search=${pager.search}">pre</a></li>
                                        </c:if>
                                        <c:forEach begin="${pager.startNum}" end="${pager.lastNum}" var="i">
                                            <li class="page-item"><a class="page-link" href="./exchange?page=${i}&kind=${pager.kind}&search=${pager.search}">${i}</a></li>
                                        </c:forEach>
                                        <li class="page-item ${pager.next?'':'disabled'}"><a class="page-link" href="./exchange?page=${pager.lastNum+1}&kind=${pager.kind}&search=${pager.search}">next</a></li>
                                    </ul>
                                </nav>
                            </div>
