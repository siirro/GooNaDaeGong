                                ...
                                <section class="col-lg-12 text-center" style="padding: 0px;">
                                    <table class="table table-hover" width="100%">
                                        <thead class="table-primary" style="font-size: 14px;">
                                            <tr>
                                                <th class="col-2">취소신청일자</th>
                                                <th class="col-1">취소번호</th>
                                                <th class="col-9">취소사유</th>
                                            </tr>
                                        </thead>
                                        <tbody style="font-size: 12px;">
                                            <tr>
                                                <td><fmt:formatDate value="${detail.can_date}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td>${detail.can_num}</td>
                                                <td>${detail.can_memo}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </section>
